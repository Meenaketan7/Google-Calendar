    ...
    setup(app) {
        (0, fs_1.readdir)(path_1.default.join(__dirname, "../routes"), (err, files) => {
            files.forEach((filename, index) => __awaiter(this, void 0, void 0, function* () {
                ...
                app.use(`/${configs_1.configs.API_VERSION}/${route}`, router.default);
                console.log(`http://${configs_1.configs.HOST}:${configs_1.configs.PORT}/${configs_1.configs.API_VERSION}/${route}\n`);
